...
// mail address verification, do not edit.
...
if(trim($first_name) == '') {
	...
	echo '<div class="error_message">Attention! Please enter a valid mail address.</div>';
	exit();
} else if(!ismail($mail)) {
...
// Enter the mail address that you want to mails to be sent to.
...
$e_reply = "You can contact $first_name via mail, $mail or via phone $phone";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	// mail has sent successfully, echo a success page.
